...
defmodule AshAi do
  ...
  @doc """
  Returns the list of Langchain functions (tools) exposed based on the provided options.
  """
  ...
  defp function(%Tool{} = tool) do
    name = Tool.name(tool)
    description = Tool.description(tool)
    parameter_schema = Tool.parameters_schema(tool)
    ...
    LangChain.Function.new!(%{
      ...
      strict: true,
      async: tool.async,
      function: &Tool.execute(tool, &1, &2)
    })
  end
